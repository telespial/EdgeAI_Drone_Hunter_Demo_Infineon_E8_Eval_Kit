...
- Date: 2026-03-27
- State: Golden + failsafe restore points promoted to latest sprite-cleanup + CIWS ballistic + 4-edge attack spawn baseline with Sting-II icon/source normalization
