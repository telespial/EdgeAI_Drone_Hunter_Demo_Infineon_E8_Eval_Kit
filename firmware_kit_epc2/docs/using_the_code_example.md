...
The following example clones the "[LVGL](https://github.com/Infineon/mtb-example-psoc-edge-gfx-lvgl-demo)" application with the desired name "MyLvglDemo" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-gfx-lvgl-demo --user-app-name MyLvglDemo --target-dir "C:/mtb_projects"
   ```
